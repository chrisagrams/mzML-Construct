...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Construct mzML from XML and binary/parquet files.")
    parser.add_argument("xml_file", help="Path to the input XML file")
    parser.add_argument("data_file", help="Path to the input data file (Parquet or binary)")
